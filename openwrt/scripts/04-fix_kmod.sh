...
pushd feeds/telephony
  ...
  git clone --depth=1 https://$github/sbwml/feeds_telephony_libs_dahdi-linux libs/dahdi-linux
popd
...
if [ "$KERNEL_CLANG_LTO" = "y" ]; then
    ...
    git clone --depth=1 https://$github/sbwml/kmod_packages_net_xtables-addons feeds/packages/net/xtables-addons
    # netatop
    ...
    git clone --depth=1 https://$gitea/sbwml/feeds_packages_libs_dmx_usb_module feeds/packages/libs/dmx_usb_module
    # macremapper
    ...
    git clone --depth=1 https://$github/sbwml/kmod_packages_net_coova-chilli feeds/packages/net/coova-chilli
fi
