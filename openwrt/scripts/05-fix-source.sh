...
git clone --depth=1 https://$github/sbwml/package_network_utils_xdp-tools package/network/utils/xdp-tools

# fix gcc14
if [ "$USE_GCC14" = y ] || [ "$USE_GCC15" = y ]; then
    # linux-atm
    rm -rf package/network/utils/linux-atm
    git clone --depth=1 https://$github/sbwml/package_network_utils_linux-atm package/network/utils/linux-atm
    # glibc
